...
export { ClaySimulation } from './core/ClaySimulation.js';
...
// Colliders
export { SphereCollider, DynamicSphereCollider } from './colliders/SphereCollider.js';
export { BoxCollider, DynamicBoxCollider } from './colliders/BoxCollider.js';
export { CapsuleCollider, VerticalCapsuleCollider, DynamicCapsuleCollider } from './colliders/CapsuleCollider.js';
export { PlaneCollider, GroundPlane } from './colliders/PlaneCollider.js';
export { MeshCollider } from './colliders/MeshCollider.js';
export { SDFCollider, bakeSDF } from './colliders/SDFCollider.js';
...
export { TetVisualizer, DynamicTetVisualizer, CollisionSphereVisualizer } from './debug/TetVisualizer.js';

// Geometry generators
export { generateTube, generateRope } from './geometry/TubeGenerator.js';
