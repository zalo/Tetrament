...
export class SoftbodySimulation {
    ...
    async _compileKernels() {
        ...
        this.kernels.solveElemPass = Fn(() => {
            ...
            If(instanceIndex.greaterThanEqual(this.uniforms.tetCount), () => Return());
        ...
        this.kernels.applyElemPass = Fn(() => {
            If(instanceIndex.greaterThanEqual(this.uniforms.vertexCount), () => Return());
            ...
            const velocity = position.sub(prevPosition).div(dt).add(gravity.mul(dt)).mul(this.config.damping);
    ...
    async _compileResetKernels() {
        ...
        this.kernels.resetVertices = Fn(() => {
            If(instanceIndex.greaterThanEqual(this.uniforms.resetVertexCount), () => Return());
        ...
        this.kernels.resetTets = Fn(() => {
            If(instanceIndex.greaterThanEqual(this.uniforms.resetTetCount), () => Return());
